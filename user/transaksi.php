<?php 
include ('conn.php'); 
    $sql = "SELECT transaksi.ID_TRANSAKSI,transaksi.TANGGAL_TRANSAKSI,transaksi.STATUS_TRANSAKSI,barang.NAMA_BARANG,barang.JUMLAH_BARANG,petugas.NAMA_PETUGAS
    FROM transaksi,barang,petugas WHERE transaksi.ID_BARANG=barang.ID_BARANG && transaksi.ID_PETUGAS=petugas.ID_PETUGAS";
        ...
        <div class="card-header">
          ...
          <div class="table-responsive text-center">
            <table class="table">
              <thead>
                <tr>
                    <th><h4>ID TRANSAKSI</h4></tv>
                    <th><h4>TANGGAL TRANSAKSI</h4></th>
                    <th><h4>STATUS TRANSAKSI</h4></th>
                    <th><h4>BARANG</h4></th>
                    <th><h4>JUMLAH BARANG</h4></th>
                    <th><h4>PETUGAS</h4></th>
