<?php 
include ('conn.php'); 
    $sql = "SELECT petugas.ID_PETUGAS,petugas.USERNAME,petugas.PASSWORD,petugas.NAMA_PETUGAS,level.NAMA_LEVEL
    FROM petugas,level WHERE petugas.ID_LEVEL=level.ID_LEVEL";
        ...
        <div class="card-header">
          ...
          <div class="table-responsive text-center">
            <table class="table">
              <thead>
                <tr>
                    <th><h4>ID PETUGAS</h4></tv>
                    <th><h4>USERNAME</h4></th>
                    <th><h4>PASSWORD</h4></th>
                    <th><h4>NAMA PETUGAS</h4></th>
                    <th><h4>LEVEL</h4></th>
